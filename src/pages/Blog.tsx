...
const blogPosts = [
  ...
  },
  {
    ...
    excerpt: 'Every business that has a bank account has financial data. It\'s in that PDF statement you download at the end of every month. The problem has never been the data — it\'s been turning it into something useful.',
...
const categories = ['All', 'Founder Notes', 'Accounting Automation'];
