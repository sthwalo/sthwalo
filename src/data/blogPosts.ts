...
export const blogPosts: BlogPost[] = [
  {
    ...
    blocks: [
      ...
      { type: 'list', items: ['Upload supported financial records in Accounting Workbench.', 'Review extracted transactions and classifications.', 'Manage documents, customers, suppliers, and stock from Inventory Management.', 'Inspect journals and ledger-backed reports in Accounting Workbench, Management Accounts and Financial Statements.', 'Correct records when professional judgement is required.'] },
  ...
  },
  {
    ...
    sourceHref: '/blog/practical-fin-workflow-for-bookkeepers',
    blocks: [
      ...
      { type: 'list', items: ['Select the correct company and fiscal period.', 'Open Accounting Workbench → Upload and import a supported PDF or CSV statement.', 'Review extracted rows and possible duplicates.', 'Classify transactions and inspect reusable rules.', 'Use Accounting Workbench → Cashbook, Bank Reconciliation, General Ledger, and Operations to review the result before relying on Management Accounts and Financial Statements.'] },
  ...
  },
  {
    ...
    sourceHref: '/blog/ledger-backed-reporting-for-accountants',
    blocks: [
      ...
      { type: 'list', items: ['Review chart-of-accounts and fiscal-period context in Accounting Workbench.', 'Inspect manual and workflow-generated double-entry journals, including audit-linked reversals.', 'Use Accounting Workbench → General Ledger and Management Accounts → Trial Balance as review foundations.', 'Generate financial, VAT, payroll, inventory, management, AFS, and audit-trail outputs from the relevant current modules.', 'Export reviewed outputs in supported formats.'] },
  ...
  },
  {
    ...
    sourceHref: '/blog/what-fin-automates-and-what-remains-manual',
    blocks: [
  ...
  },
  {
    ...
    sourceHref: '/blog/what-fin-automates-and-what-remains-manual',
    blocks: [
      { type: 'paragraph', text: 'Compliance holds the preparation work for SARS, CIPC and Labour: VAT, payroll taxes, and the income tax computation. Every figure traces back through journals to the operational records that produced it, which is the part that matters when a number has to be explained rather than merely reported.' },
